...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-6 font-[Inter]">
    <div class="w-full max-w-[400px] bg-white p-10 rounded-[40px] shadow-2xl border border-white">
        ...
        <form action="index.php" method="POST" class="space-y-5">
            <input type="text" name="cpf" placeholder="CPF" class="w-full p-4 rounded-2xl bg-slate-50 border outline-none focus:ring-2 focus:ring-blue-400">
            <input type="password" name="password" placeholder="Senha" class="w-full p-4 rounded-2xl bg-slate-50 border outline-none focus:ring-2 focus:ring-blue-400">
